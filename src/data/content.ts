...
export const hosts: Host[] = [
  {
    ...
    image: hostA,
    bio: "Author, organizer, and community advocate. Two decades on the ground in his city, J. Carter brings lived experience to every conversation.",
  },
  {
    slug: "big-mike",
    name: "Big Mike",
    ...
    image: hostB,
    bio: "Cultural strategist and former coach. Big Mike steers the show with sharp questions and zero filter.",
  },
];
...
export const memberships = [
  ...
  },
  {
    ...
    features: [
      ...
      "Member-only livestream events",
      "Annual signed merch drop",
      "VIP event access",
      "25% merch discount",
    ],
    cta: "Join the Family",
