...
function SponsorsPage() {
  return (
    <>
      ...
      <section className="py-20 border-t border-border bg-[#F7F8FA]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <Link to="/contact" className="inline-block bg-brand text-brand-foreground px-8 py-4 font-bold uppercase tracking-widest text-sm hover:bg-[#6A33A5] transition-colors">
