...
const cardDisclosures: Record<string, string> = {
  "The Audience": "Renews automatically each month until canceled. Eligible first-wave members keep the $7 monthly rate while their membership remains continuously active.",
  "The Network": "Renews automatically each month until canceled. Eligible first-wave members keep the $19 monthly rate while their membership remains continuously active.",
};

const whyCards = [
  {
    icon: Eye,
    title: "Go Behind the Conversation",
    body: "Get early episodes, bonus clips, After Hours content, and behind-the-scenes discussions that are not available to the general public.",
  },
  {
    icon: MessageSquare,
    title: "Make Your Voice Heard",
    body: "Submit questions, recommend topics, comment on posts, participate in discussions, and help influence future content.",
  },
  {
    icon: Users,
    title: "Build Real Connections",
    body: "Connect with members, creators, entrepreneurs, community leaders, and others who want to turn conversation into relationships and opportunity.",
  },
  {
    icon: Sparkles,
    title: "Get Closer to Tha Fix",
    body: "Access member sessions, special opportunities, future events, collaborations, and other experiences based on your membership level.",
  },
];
...
const howSteps = [
  ...
  { title: "Complete secure checkout", body: "Payments are processed securely through Stripe." },
  ...
  return (
    <>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          <p className="text-lg text-muted-foreground leading-relaxed mb-10">
            Tha Fix memberships give you more access to the content, conversations, community, and opportunities behind the show. Choose the level that fits how you want to participate.
          </p>
          <div className="border border-accent bg-accent/10 p-6 md:p-8 text-left">
            <div className="text-accent-foreground/90 text-[11px] font-bold uppercase tracking-[0.3em] mb-2 text-brand">Launch Offer</div>
            ...
            <p className="text-muted-foreground leading-relaxed">
              The first 100 qualifying members at each available launch level can secure special introductory pricing and benefits, subject to the{" "}
              <Link to="/membership-terms" className="underline text-brand hover:text-accent">Membership Terms</Link>.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
          <div className="max-w-3xl mb-12">
            ...
            <h2 className="font-display text-4xl md:text-5xl font-bold tracking-tight mb-5">
              More Than Exclusive Content
            </h2>
            <p className="text-muted-foreground leading-relaxed">
              A Tha Fix membership brings you closer to the conversations, people, and opportunities shaping our growing network.
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {whyCards.map((c) => (
              <div key={c.title} className="bg-surface border border-border p-7">
                <c.icon className="w-8 h-8 text-brand mb-5" />
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 grid md:grid-cols-3 gap-6">
          {memberships.map((m) => (
            ...
            >
              ...
              {cardDisclosures[m.name] && (
                <p className={`mt-4 text-[11px] leading-relaxed ${m.featured ? "text-white/80" : "text-muted-foreground"}`}>
                  {cardDisclosures[m.name]}
                </p>
              )}
            </div>
      ...
      <section className="py-20 bg-brand text-brand-foreground">
        <div className="max-w-3xl mx-auto px-6 lg:px-10">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold tracking-tight mb-6 text-balance">
            Lock In Your First-Wave Membership Rate
          </h2>
          <p className="leading-relaxed mb-6 opacity-90">
            Tha Fix is offering special pricing to its earliest members:
          </p>
          <ul className="space-y-3 mb-6">
            {[
              "The Audience: $7 per month during the first wave; $9 per month afterward",
              "The Network: $19 per month during the first wave; $29 per month afterward",
              "The Founder: $297 one-time and limited to 100 memberships",
              "After The Founder closes, The Inner Circle will become available for $497 one-time",
            ].map((line) => (
          ...
          <p className="leading-relaxed opacity-80 text-sm">
            Eligible Audience and Network members keep their introductory monthly rates as long as their membership remains continuously active. If a membership is canceled and the person later rejoins, the then-current price will apply.
          </p>
        </div>
      </section>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  ["Priority questions for member sessions", false, false, true],
                ].map(([label, ...vals]) => (
      ...
      <section className="py-20 bg-[#F7F8FA] border-y border-border">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-10">
          <div className="max-w-3xl mb-12">
            <div className="text-brand text-[11px] font-bold uppercase tracking-[0.3em] mb-3">How Membership Works</div>
            <h2 className="font-display text-4xl md:text-5xl font-bold tracking-tight">Joining Tha Fix Is Simple</h2>
          </div>
          <ol className="grid md:grid-cols-2 lg:grid-cols-5 gap-5">
            {howSteps.map((s, i) => (
              <li key={s.title} className="bg-surface border border-border p-6">
                <div className="font-display text-4xl font-black text-brand mb-3">{String(i + 1).padStart(2, "0")}</div>
      ...
      <section className="py-24 lg:py-32">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          ...
          <h2 className="font-display text-4xl md:text-6xl font-bold tracking-tight mb-6 text-balance">
            Help Build What Tha Fix Becomes
          </h2>
          <p className="text-muted-foreground leading-relaxed mb-5">
            Tha Fix was created to have honest conversations, bring different generations and perspectives together, and turn those conversations into stronger relationships and opportunities.
          </p>
      ...
      <section className="py-20 bg-[#F7F8FA] border-y border-border">
        <div className="max-w-3xl mx-auto px-6 lg:px-10">
          <div className="text-brand text-[11px] font-bold uppercase tracking-[0.3em] mb-3">Membership FAQ</div>
      ...
      <section className="py-24 lg:py-32 bg-brand text-brand-foreground">
        <div className="max-w-3xl mx-auto px-6 lg:px-10 text-center">
          <h2 className="font-display text-4xl md:text-6xl font-black tracking-tight mb-6 text-balance">
            Choose How You Want to Be Part of Tha Fix
          </h2>
          ...
          <p className="text-xs opacity-75 leading-relaxed max-w-2xl mx-auto">
            By purchasing a membership, you confirm that you are at least 18 years old and agree to the{" "}
            <Link to="/terms" className="underline hover:text-accent">Terms of Use</Link>,{" "}
            <Link to="/membership-terms" className="underline hover:text-accent">Membership Terms</Link>,{" "}
            <Link to="/privacy" className="underline hover:text-accent">Privacy Policy</Link>, and applicable{" "}
            <Link to="/guidelines" className="underline hover:text-accent">Community Guidelines</Link>.
          </p>
        </div>
      </section>
    </>
